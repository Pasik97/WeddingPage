...
const infos = [
    { icon: <BusIcon />, text: "Od godziny 1:00 w nocy kursować będzie bus 10-osobowy, a od godziny 3:00 dołączy do niego drugi kierowca z busem 24-osobowym. Zachęcamy do skorzystania z transportu i odebrania samochodów następnego dnia, aby móc w pełni cieszyć się zabawą bez zmartwień." },
