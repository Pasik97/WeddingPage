...
const AboutUs: React.FC = () => (
    <>
        <S.SectionWrapper id="aboutUs">
            ...
            <S.SectionSubText>Rok 2024 przyniósł nam kolejny wyjątkowy rozdział – zaręczyny. Był to dzień pełen wzruszeń, radości i cichego przeczucia, że teraz zaczyna się coś jeszcze piękniejszego.</S.SectionSubText>
