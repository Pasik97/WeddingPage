...
const Contact: React.FC = () => (
    <S.SectionWrapper id="contact">
        <S.ContentWrapper>
            ...
            <S.Info>Jeśli masz jakiekolwiek pytania dotyczące zdjęć, filmu czy innych szczegółów – jesteśmy do Twojej dyspozycji! Chętnie pomożemy i rozwiejemy wszelkie wątpliwości.</S.Info>
            <div>
